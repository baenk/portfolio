...
function setInitSetting(){
    ...
    if(gl_conf_header.KIOSK_SECT == "SHPM"){
        $(".right_mnu_logo_box > img").attr("src", "./images/logo_right_menu_mall.svg");
    }else if(gl_conf_header.KIOSK_SECT == "TWER"){
        $(".right_mnu_logo_box > img").attr("src", "./images/logo_right_menu_tower.svg");
    }else if(gl_conf_header.KIOSK_SECT == "AVNL"){
        $(".right_mnu_logo_box > img").attr("src", "./images/logo_right_menu_avenuel.svg");
    }
...
function setMainLang(p_lang){
    ...
    $(".rectangle_shop").each(function(i){
        try{
            ...
            console.log("ERROR BTN INDEX : " + str_attr);
        }
    });
}
...
function setParentCmd(p_obj){
    ...
    if(p_obj.sect == "POPUP"){
        ...
        //setCallWebToApp("BIG_DATA","STATUS");
    ...
    for(i = 0; i < gl_arr_store_list.length && i < 3000; i++){
        ...
        if(p_id == obj.ID){
            ...
            if(obj.TYPE == "STORE"){
                ...
                $("#id_popup_store .pop_detail_info_box").css({"height":"108px"});
...
function onClickDebug03(){
    ...
    setMakeInfoPopUpFacility("0400","04");
