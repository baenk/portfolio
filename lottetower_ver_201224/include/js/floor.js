...
function setMainLang(p_lang){
    ...
    if(gl_main_conf.lang == "KOR"){
        ...
        $("#id_page_floor_all_map img").attr("src","./images/floor/floor-img-all_vertical_kor.png");
    }else if(gl_main_conf.lang == "ENG"){
        gl_map_draws.changeLanguage("en");
        $("#id_page_floor_all_map img").attr("src","./images/floor/floor-img-all_vertical_eng.png");
    }else if(gl_main_conf.lang == "CHN"){
        gl_map_draws.changeLanguage("zh-CN");
        $("#id_page_floor_all_map img").attr("src","./images/floor/floor-img-all_vertical_chn.png");
    }else if(gl_main_conf.lang == "JPN"){
        gl_map_draws.changeLanguage("ja");
        $("#id_page_floor_all_map img").attr("src","./images/floor/floor-img-all_vertical_jpn.png");
    }
...
function setMainStart(p_obj){
    ...
    if(p_obj.sect == "WAYFIND"){
        ...
        if(p_obj.type == "PARK"){  // wayfind
            ...
            //console.log("gl_map_conf.wayfind_floorgl_map_conf.wayfind_floor = " + gl_map_conf.wayfind_floor);
            setMainWayFind();
        }
    }
}
...
function setMainWayFindStart(p_type){
    ...
    //console.log("FIND START FIND START = " + p_type);
    ...
    if(gl_map_conf.wayfind_type == "PARK" || gl_map_conf.wayfind_type == "PHOTOSPOT"){
        ...
        gl_map_draws.startRouteAnimation({zoom: 200});
...
function setMakeMapInitEnd(){
    ...
    //console.log("gl_map_conf.my_floor_id 02 = " + gl_map_conf.my_floor_id);
    ...
    /*
    document.querySelector("#id_page_map_main").addEventListener("object-click", (evt) => {
        //onClickMapFloor(evt);
    });
    */
...
function setMapMoveFloor(p_code){
    ...
    for(i = 0; i < gl_arr_floor_list.length; i++){
        ...
        if(obj[0] == p_code){
            ...
            console.log("setMapMoveFloor");
            gl_map_draws.zoomControl(160);
...
function onClickInfoFloorAll(){
    ...
    $("#id_page_floor_all_map").scrollLeft(0);
...
function onClickFloorAllMove(p_type){
    ...
    if(p_type == "PREV"){
        ...
        $("#id_page_floor_all_map").animate({scrollLeft:450},300);
...
function onClickPopupClose(p_type){
    ...
    if(p_type == "SELECT"){
        ...
        $("#id_popup_bg").fadeOut(gl_main_conf.speed);
        $("#id_popup_select").fadeOut(gl_main_conf.speed);
        //$("#id_popup_select").removeClass('popup_animate_show');
