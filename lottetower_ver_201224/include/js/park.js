                ...
                if(json_obj.result[0].VEHICLE_LIST.length > 0){
                    ...
                    for(i = 0; i < json_obj.result[0].VEHICLE_LIST.length && i < 100; i++){
                        ...
                        if(arr_area.length == 3){
                            ...
                            str_html += "  </div>";
                            if(str_poi_id != ""){
                                str_html += "  <div class=\"car_park_loc\"><span class=\"rectangle_loc rectangle_loc_active\" onClick=\"javascript:onClickWayFind('" + str_poi_id + "','" + str_floor + "');\"><img src=\"images/pop_location_btn01.png\"><p>" + str_guide + "</p></span></div>";
                            }else{
                               str_html += " <div></div>";
                            }
                            str_html += "</li>";
