...
/*
function setInitMakeHelpList_Old(){
    var i = 0, j = 0;
    var obj;
    ...
    for(i = 0; i < gl_arr_help_list.length && i < 3000; i++){
        ...
        str_html  = "<li id=\"id_help_id_" + obj.ID + "\">";
        if(obj.BRN_ID == "16" || obj.BRN_ID == "13"){
            str_html += "  <span class=\"rectangle_info_free lang_name\" style=\"vertical-align:top;width:370px;\"><p>" + obj.TENANT_NAME_KOR + "</p>" + obj.TENANT_FLOOR + "</span>";
            str_html += "  <p class=\"lang_desc\" style=\"vertical-align:top;\">" + str_desc + "</p>";
        }else{
            str_html += "  <span class=\"rectangle_info_free lang_name\" style=\"vertical-align:top;\"><p>" + obj.TENANT_NAME_KOR + "</p>" + obj.TENANT_FLOOR + "</span>";
            str_html += "  <p class=\"lang_desc\" style=\"vertical-align:top;\">" + str_desc + "</p>";
        }
        str_html += "</li>";
        ...
        if(obj.BRN_ID == "13"){
            if( obj.TENANT_NAME_KOR != "시그니엘서울"){
                ...
                str_html_tower += "<li id=\"id_help_id_signiel\" >";
                str_html_tower += "  <span class=\"rectangle_info_free rectangle_info_active\" onClick=\"javascript:onClickInfoView('VIEW_SIGNIEL');\"><p class=\"lang_code_names\" lang_code=\"HELP_INFO_SIGNIEL\">시그니엘 서울</p>76F-101F [<span class=\"lang_code_names\" lang_code=\"HELP_INFO_DETAIL\">상세보기</span>]</span>";
                str_html_tower += "  <p>&nbsp;</p>";
                str_html_tower += "</li>";
            }
        }else if(obj.BRN_ID == "16"){
    ...
    str_html_tower += "<li id=\"id_help_id_podium\" >";
    str_html_tower += "  <span class=\"rectangle_info_free rectangle_info_active\" onClick=\"javascript:onClickInfoView('VIEW_PODIUM');\"><p class=\"lang_code_names\" lang_code=\"HELP_INFO_PODIUM\">포디엄</p>B1F-12F [<span class=\"lang_code_names\" lang_code=\"HELP_INFO_DETAIL\">상세보기</span>]</span>";
    str_html_tower += "  <p>&nbsp;</p>";
    str_html_tower += "</li>";
...
function setMainLang(p_lang){
    ...
    if(gl_main_conf.lang == "KOR"){
        $("#id_page_traffic_box_bus").attr("src","images/info_img_bus_kor.png");
        $("#id_page_traffic_box_transfer").attr("src","images/info_img_transfer_kor.png");
    }else if(gl_main_conf.lang == "ENG"){
        $("#id_page_traffic_box_bus").attr("src","images/info_img_bus_eng.png");
        $("#id_page_traffic_box_transfer").attr("src","images/info_img_transfer_eng.png");
    }else if(gl_main_conf.lang == "CHN"){
        $("#id_page_traffic_box_bus").attr("src","images/info_img_bus_chn.png");
        $("#id_page_traffic_box_transfer").attr("src","images/info_img_transfer_chn.png");
    }else if(gl_main_conf.lang == "JPN"){
        $("#id_page_traffic_box_bus").attr("src","images/info_img_bus_jpn.png");
        $("#id_page_traffic_box_transfer").attr("src","images/info_img_transfer_jpn.png");
    }
...
function setMainStart(p_obj){
    ...
    $("#id_info_time_podium_list").scrollTop(0);
    $("#id_info_time_signiel_list").scrollTop(0);
}
...
function onClickInfoView(p_type){
    ...
    if(p_type == "TRAFFIC_BUS"){
        ...
        //$("#id_popup_podium").addClass("popup_animate_show");
